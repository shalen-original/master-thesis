...
#ifndef __QUATERNION_SHADER__
#define __QUATERNION_SHADER__
...
float3 rotate_point_around_pivot(float3 p, float3 pivot, float4 quaternion)
{
    return rotate_vector(p - pivot, quaternion) + pivot;
}
